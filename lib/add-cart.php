<?php
session_start();
require "db.php"; // Путь остается тот же, так как файл находится в одной папке с db.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SESSION['user_id'])) {
    ...
    try {
        ...
        if ($product) {
            ...
            exit(); // Убедитесь, что выполнение скрипта завершено после перенаправления
        } else {
