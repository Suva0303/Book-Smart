...
<div class="wrapper">
    <div class="container">
        <h1>Каталог Книг</h1> <!-- Закрыл тег h1 -->
        <?php
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    if (!empty($row['image'])) {
                        $imagePath = "../../images/catalog/" . $row['image']; // htmlspecialchars убрал здесь
                    }
                    ...
                    echo '
                        <div class="card">
                            ...
                            <div class="card__bottom"> <!-- Исправил название класса -->
                ...
                echo '</div>'; // Закрываем div с классом cards
            } else {
                // Если данных нет
